...
public key and private key for encryption and decryption.
* @param k is the security parameter, which decides the length of two large primes (p and q).
* @return void
*/
...
/**
* @Title: encrypt
* @Description: This function is to encrypt the message with Paillier’s public key.
* @param m The message.
*
* @param pubkey
